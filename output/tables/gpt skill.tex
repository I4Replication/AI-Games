...
[1em]
\shortstack{Ran at least two appropriate robustness checks} & \shortstack{0.938\\(0.250)} & \shortstack{0.828\\(0.384)} & \shortstack{0.667\\(0.488)} & \shortstack{0.484\\(0.508)} & \shortstack{0.110\\\relax[0.253]} & \shortstack{0.183\\\relax[0.250]}\\
\bottomrule
\end{tabular} 
 }
 \\
