...
[1em]
\shortstack{At least two appropriate robustness checks} & \shortstack{0.826\\(0.388)} & \shortstack{0.957\\(0.209)} & \shortstack{-0.130\\\relax[0.164]}\\
[1em]
\shortstack{Ran at least one appropriate robustness check} & \shortstack{0.957\\(0.209)} & \shortstack{0.957\\(0.209)} & \shortstack{0.000\\\relax[1.000]}\\
[1em]
\shortstack{Ran at least two appropriate robustness checks} & \shortstack{0.783\\(0.422)} & \shortstack{0.913\\(0.288)} & \shortstack{-0.130\\\relax[0.228]}\\
\bottomrule
\end{tabular} 
 }
 \\
 \multicolumn{4}{p{0.8\textwidth}}{\textit{Note:} Columns 2--3 present means and standard errors in parentheses for individual groups (Human-only, AI-Assisted, and AI-Led); the Difference column shows mean differences and $p$-values in brackets for the indicated group comparison. Groups are defined by the median number of prompts ( 25.5 ) in the AI-Assisted sample.}
 \end{table}